...
return goog.events.listen(window,"load",listener);
});
...
return [(function (){var pred__10743 = cljs.core.instance_QMARK_;
var expr__10744 = reactive_val;
if(cljs.core.truth_(pred__10743.call(null,reagent.ratom.RAtom,expr__10744))){
return "ra";
} else {
if(cljs.core.truth_(pred__10743.call(null,reagent.ratom.RCursor,expr__10744))){
return "rc";
} else {
if(cljs.core.truth_(pred__10743.call(null,reagent.ratom.Reaction,expr__10744))){
return "rx";
} else {
if(cljs.core.truth_(pred__10743.call(null,reagent.ratom.Track,expr__10744))){
return "tr";
} else {
return "other";
}
