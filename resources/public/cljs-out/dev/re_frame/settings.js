...
re_frame.settings.reg_global_interceptor = (function re_frame$settings$reg_global_interceptor(p__11325){
...
var interceptor = map__11326__$1;
var id = cljs.core.get.call(null,map__11326__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
return cljs.core.swap_BANG_.call(null,re_frame.settings.store,cljs.core.update,new cljs.core.Keyword(null,"global-interceptors","global-interceptors",-1995759472),((function (map__11326,map__11326__$1,interceptor,id){
...
if(cljs.core.truth_((function (){var and__4120__auto__ = cljs.core.not.call(null,re_frame.settings.loaded_QMARK_.call(null));
if(and__4120__auto__){
return cljs.core.some.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([id]),ids);
} else {
...
});})(map__11326,map__11326__$1,interceptor,id))
);
});
...
return cljs.core.into.call(null,re_frame.interop.empty_queue,cljs.core.remove.call(null,(function (p1__11328_SHARP_){
return cljs.core._EQ_.call(null,id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__11328_SHARP_));
}),global_interceptors));
}));
});
