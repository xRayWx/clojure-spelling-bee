...
var o__18509__auto___19821 = (function (){var o__18509__auto__ = (function (){var o__18509__auto__ = Promise;
return (o__18509__auto__["resolve"]).call(o__18509__auto__);
})();
return (o__18509__auto__["then"]).call(o__18509__auto__,callback);
})();
(o__18509__auto___19821["catch"]).call(o__18509__auto___19821,devtools.async.rethrow_outside_promise);
...
var G__19822_19823 = Error;
var target__18514__auto___19824 = G__19822_19823;
if(cljs.core.truth_(target__18514__auto___19824)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19822_19823)].join(''),"\n","target__18514__auto__"].join('')));
}

(target__18514__auto___19824["stackTraceLimit"] = Infinity);
