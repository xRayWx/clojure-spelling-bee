...
var G__18762 = devtools.prefs.pref.call(null,v);
v = G__18762;
continue;
} else {
return v;
...
}catch (e18765){var _e__18516__auto__ = e18765;
return false;
}})();
...
}catch (e18769){var _e__18516__auto__ = e18769;
return false;
}})();
...
}catch (e18771){var _e__18516__auto__ = e18771;
return false;
}}
}
});
...
var vec__18773 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__18773,(0),null);
var name = cljs.core.nth.call(null,vec__18773,(1),null);
...
return cljs.core.some.call(null,(function (p1__18776_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__18776_SHARP_);
}),template);
});
