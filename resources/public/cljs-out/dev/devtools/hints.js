...
}catch (e19841){var _e = e19841;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___19844 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___19844)){
var seen_errors_19845 = temp__5455__auto___19844;
if(cljs.core.truth_(seen_errors_19845.has(self))){
} else {
seen_errors_19845.add(self);

var temp__5457__auto___19846 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___19846)){
var sense_19847 = temp__5457__auto___19846;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_19847)].join('');
} else {
}
}
} else {
