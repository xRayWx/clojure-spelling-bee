...
var G__15647 = o;
(G__15647[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__15649__i < G__15649__a.length) {G__15649__a[G__15649__i] = arguments[G__15649__i + 0]; ++G__15649__i;}
  args = new cljs.core.IndexedSeq(G__15649__a,0,null);
} 
...
var G__15651 = o;
(G__15651[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__15652__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__15653__i < G__15653__a.length) {G__15653__a[G__15653__i] = arguments[G__15653__i + 0]; ++G__15653__i;}
  args = new cljs.core.IndexedSeq(G__15653__a,0,null);
} 
return G__15652__delegate.call(this,args);};
G__15652.cljs$lang$maxFixedArity = 0;
G__15652.cljs$lang$applyTo = (function (arglist__15654){
var args = cljs.core.seq(arglist__15654);
return G__15652__delegate(args);
});
...
var G__15656 = props;
var G__15656__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__15656,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__15656);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__15656__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__15657){
...
var props = map__15658__$1;
var class$ = cljs.core.get.call(null,map__15658__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__15658,map__15658__$1,props,class$){
return (function (c){
...
});})(map__15658,map__15658__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__15660){
var map__15661 = p__15660;
var map__15661__$1 = (((((!((map__15661 == null))))?(((((map__15661.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15661.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15661):map__15661);
var on_write = cljs.core.get.call(null,map__15661__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__15661,map__15661__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__15661,map__15661__$1,on_write))
);
} else {
...
var G__15664 = jsprops;
(G__15664["defaultValue"] = value);

(G__15664["onChange"] = ((function (G__15664,v,value,on_change){
return (function (p1__15663_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__15663_SHARP_);
});})(G__15664,v,value,on_change))
);
...
var vec__15667 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__15667,(0),null);
var id = cljs.core.nth.call(null,vec__15667,(1),null);
var class$ = cljs.core.nth.call(null,vec__15667,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___15671 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___15671 == null)){
} else {
var key_15672 = temp__5461__auto___15671;
(jsprops["key"] = key_15672);
}
...
var temp__5461__auto___15673 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___15673 == null)){
} else {
var key_15674 = temp__5461__auto___15673;
reagent.impl.template.oset.call(null,jsprops,"key",key_15674);
}
...
var G__15675 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__15675["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq15679){
var G__15680 = cljs.core.first.call(null,seq15679);
var seq15679__$1 = cljs.core.next.call(null,seq15679);
...
break;
default:
var G__15686 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__15686;
continue;
...
var n__4607__auto___15688 = a.length;
var i_15689 = (0);
while(true){
if((i_15689 < n__4607__auto___15688)){
(a[i_15689] = reagent.impl.template.as_element.call(null,(a[i_15689])));

var G__15690 = (i_15689 + (1));
i_15689 = G__15690;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___15691 = a.length;
var i_15692 = (0);
while(true){
if((i_15692 < n__4607__auto___15691)){
var val_15693 = (a[i_15692]);
if(((cljs.core.vector_QMARK_.call(null,val_15693)) && ((reagent.impl.template.key_from_vec.call(null,val_15693) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_15692] = reagent.impl.template.as_element.call(null,val_15693));

var G__15694 = (i_15692 + (1));
i_15692 = G__15694;
continue;
} else {
}
...
var ctx = ({});
var vec__15695 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__15695,(0),null);
var derefed = cljs.core.nth.call(null,vec__15695,(1),null);
...
var G__15698 = (cljs.core.count.call(null,argv) - first_child);
switch (G__15698) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__15698){
