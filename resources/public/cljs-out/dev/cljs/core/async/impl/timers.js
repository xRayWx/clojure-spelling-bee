...
var i_13263 = (self__.level + (1));
while(true){
if((i_13263 <= (new_level + (1)))){
(update[i_13263] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13265 = (update[i]).forward;
(x__$2.forward[i] = (links_13265[i]));
...
if((x__$1 === (((i_13267 < links_13268.length))?(links_13268[i_13267]):null))){
