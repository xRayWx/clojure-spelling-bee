...
var G__17466 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__17466,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__17466;
}
});
...
var len__4730__auto___17471 = arguments.length;
var i__4731__auto___17472 = (0);
while(true){
if((i__4731__auto___17472 < len__4730__auto___17471)){
args__4736__auto__.push((arguments[i__4731__auto___17472]));

var G__17473 = (i__4731__auto___17472 + (1));
i__4731__auto___17472 = G__17473;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq17468){
var G__17469 = cljs.core.first.call(null,seq17468);
var seq17468__$1 = cljs.core.next.call(null,seq17468);
var G__17470 = cljs.core.first.call(null,seq17468__$1);
var seq17468__$2 = cljs.core.next.call(null,seq17468__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17469,G__17470,seq17468__$2);
});
...
var file = cljs.core.get.call(null,map__17475__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__17475__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__17475__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__17475,map__17475__$1,file,line,column){
return (function (p1__17474_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__17474_SHARP_));
});})(map__17475,map__17475__$1,file,line,column))
...
var temp__5457__auto___17477 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___17477)){
var message_17478 = temp__5457__auto___17477;
cljs.core.println.call(null,message_17478);
} else {
}
...
var temp__5457__auto___17479 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___17479)){
var message_17480 = temp__5457__auto___17479;
cljs.core.println.call(null,message_17480);
} else {
}
...
var output_dir__$1 = (function (){var G__17481 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__17481,"/"].join('');
} else {
return G__17481;
}
})();
...
var G__17483 = exception.stack;
var G__17483__$1 = (((G__17483 == null))?null:clojure.string.split_lines.call(null,G__17483));
var G__17483__$2 = (((G__17483__$1 == null))?null:cljs.core.get.call(null,G__17483__$1,depth));
if((G__17483__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__17483__$2);
}
} else {
...
var vec__17484 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__17484,(0),null);
var column = cljs.core.nth.call(null,vec__17484,(1),null);
var vec__17487 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__17487,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__17487,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__17487,(2),null);
...
var m__$1 = (function (){var G__17490 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__17490__$1 = (((G__17490 instanceof cljs.core.Keyword))?G__17490.fqn:null);
switch (G__17490__$1) {
case "fail":
...
var G__17494 = (function (){var G__17493 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__17493);
} else {
return G__17493;
}
})();
...
return cljs.core.vary_meta.call(null,G__17495,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e17496){var e = e17496;
var G__17497 = e;
var G__17497__$1 = (((G__17497 instanceof cljs.core.Keyword))?G__17497.fqn:null);
switch (G__17497__$1) {
...
var vec__17499 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__17499,(0),null);
var types = vec__17499;
...
return cljs.core.map.call(null,(function (p__17502){
var vec__17503 = p__17502;
var ns = cljs.core.nth.call(null,vec__17503,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__17503,(1),null);
return ((function (vec__17503,ns,vars__$1){
return (function (){
...
var G__17506 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__17506,G__17506__$1,env,once_fixtures,each_fixtures,vec__17503,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__17506,G__17506__$1,env,once_fixtures,each_fixtures,vec__17503,ns,vars__$1){
return (function (){
var seq__17507 = cljs.core.seq.call(null,vars__$1);
var chunk__17508 = null;
var count__17509 = (0);
var i__17510 = (0);
while(true){
if((i__17510 < count__17509)){
var v = cljs.core._nth.call(null,chunk__17508,i__17510);
var temp__5457__auto___17512 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___17512)){
var t_17513 = temp__5457__auto___17512;
each_fixture_fn.call(null,((function (seq__17507,chunk__17508,count__17509,i__17510,t_17513,temp__5457__auto___17512,v,each_fixture_fn,G__17506,G__17506__$1,env,once_fixtures,each_fixtures,vec__17503,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17513)));
});})(seq__17507,chunk__17508,count__17509,i__17510,t_17513,temp__5457__auto___17512,v,each_fixture_fn,G__17506,G__17506__$1,env,once_fixtures,each_fixtures,vec__17503,ns,vars__$1))
);
} else {
}


var G__17514 = seq__17507;
var G__17515 = chunk__17508;
var G__17516 = count__17509;
var G__17517 = (i__17510 + (1));
seq__17507 = G__17514;
chunk__17508 = G__17515;
count__17509 = G__17516;
i__17510 = G__17517;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__17507);
if(temp__5457__auto__){
var seq__17507__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__17507__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__17507__$1);
var G__17518 = cljs.core.chunk_rest.call(null,seq__17507__$1);
var G__17519 = c__4550__auto__;
var G__17520 = cljs.core.count.call(null,c__4550__auto__);
var G__17521 = (0);
seq__17507 = G__17518;
chunk__17508 = G__17519;
count__17509 = G__17520;
i__17510 = G__17521;
continue;
} else {
var v = cljs.core.first.call(null,seq__17507__$1);
var temp__5457__auto___17522__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___17522__$1)){
var t_17523 = temp__5457__auto___17522__$1;
each_fixture_fn.call(null,((function (seq__17507,chunk__17508,count__17509,i__17510,t_17523,temp__5457__auto___17522__$1,v,seq__17507__$1,temp__5457__auto__,each_fixture_fn,G__17506,G__17506__$1,env,once_fixtures,each_fixtures,vec__17503,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_17523)));
});})(seq__17507,chunk__17508,count__17509,i__17510,t_17523,temp__5457__auto___17522__$1,v,seq__17507__$1,temp__5457__auto__,each_fixture_fn,G__17506,G__17506__$1,env,once_fixtures,each_fixtures,vec__17503,ns,vars__$1))
);
} else {
}


var G__17524 = cljs.core.next.call(null,seq__17507__$1);
var G__17525 = null;
var G__17526 = (0);
var G__17527 = (0);
seq__17507 = G__17524;
chunk__17508 = G__17525;
count__17509 = G__17526;
i__17510 = G__17527;
continue;
}
} else {
...
});})(each_fixture_fn,G__17506,G__17506__$1,env,once_fixtures,each_fixtures,vec__17503,ns,vars__$1))
);
});})(each_fixture_fn,G__17506,G__17506__$1,env,once_fixtures,each_fixtures,vec__17503,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17506__$1)].join('')));

}
})());
});
;})(vec__17503,ns,vars__$1))
